...
-- Volcando datos para la tabla sistema_negocio.asistente_ia_assistantknowledgearticle: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_negocio.asistente_ia_assistantplaybook: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_negocio.asistente_ia_assistantquickreply: ~8 rows (aproximadamente)
...
-- Volcando estructura para tabla sistema_negocio.asistente_ia_conversationmessage
CREATE TABLE IF NOT EXISTS `asistente_ia_conversationmessage` (
  ...
  PRIMARY KEY (`id`),
  KEY `asistente_ia_convers_thread_id_db7f5658_fk_asistente` (`thread_id`),
  CONSTRAINT `asistente_ia_convers_thread_id_db7f5658_fk_asistente` FOREIGN KEY (`thread_id`) REFERENCES `asistente_ia_conversationthread` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sistema_negocio.asistente_ia_conversationmessage: ~34 rows (aproximadamente)
...
-- Volcando estructura para tabla sistema_negocio.asistente_ia_conversationthread
CREATE TABLE IF NOT EXISTS `asistente_ia_conversationthread` (
  ...
  PRIMARY KEY (`id`),
  KEY `asistente_ia_convers_usuario_id_456ba82a_fk_auth_user` (`usuario_id`),
  CONSTRAINT `asistente_ia_convers_usuario_id_456ba82a_fk_auth_user` FOREIGN KEY (`usuario_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sistema_negocio.asistente_ia_conversationthread: ~12 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_negocio.auth_permission: ~96 rows (aproximadamente)
...
INSERT INTO `auth_user` (`id`, `password`, `last_login`, `is_superuser`, `username`, `first_name`, `last_name`, `email`, `is_staff`, `is_active`, `date_joined`) VALUES
	...
	(2, 'pbkdf2_sha256$1000000$LnCcyS3JAbLnu8OcMupBTT$bc0lw8TgvI3UJyviyceBwtOBaI/EQFIacG2yRqLE9es=', '2025-11-15 00:54:36.924252', 1, 'admin', '', '', 'admin@gmail.com', 1, 1, '2025-11-11 20:06:13.956375');
...
-- Volcando datos para la tabla sistema_negocio.caja_movimientocaja: ~3 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `configuracion_configuracionsistema` (
  ...
  `envios_nacionales` varchar(200) NOT NULL,
  `facebook` varchar(200) NOT NULL,
  `google_maps_url` varchar(200) NOT NULL,
  `horario_domingos` varchar(100) NOT NULL,
  `horario_lunes_a_viernes` varchar(100) NOT NULL,
  `horario_sabados` varchar(100) NOT NULL,
  `instagram_empresa` varchar(100) NOT NULL,
  `instagram_principal` varchar(100) NOT NULL,
  ...
  `politica_envio` longtext NOT NULL,
  `telefono_local` varchar(40) NOT NULL,
...
INSERT INTO `configuracion_configuracionsistema` (`id`, `nombre_comercial`, `lema`, `logo`, `color_principal`, `modo_oscuro_predeterminado`, `mostrar_alertas`, `whatsapp_numero`, `acceso_admin_habilitado`, `contacto_email`, `domicilio_comercial`, `notas_sistema`, `dolar_blue_manual`, `ultima_actualizacion`, `correo_contacto`, `costo_envio_local`, `costo_envio_nacional`, `descuento_efectivo_porcentaje`, `envios_disponibles`, `envios_locales`, `envios_nacionales`, `facebook`, `google_maps_url`, `horario_domingos`, `horario_lunes_a_viernes`, `horario_sabados`, `instagram_empresa`, `instagram_principal`, `instagram_secundario`, `nombre_local`, `pago_efectivo_local`, `pago_efectivo_retiro`, `pago_online`, `pago_online_link`, `pago_tarjeta`, `pago_transferencia`, `politica_envio`, `telefono_local`, `telefono_whatsapp`, `tiktok`, `transferencia_alias`, `transferencia_cbu`, `ubicacion_mapa`, `whatsapp_alternativo`) VALUES
	(1, 'ImportSt', 'Distribuidora de tecnología', 'branding/Belgrano_47_San_Luis..png', '#ffffff', 0, 1, '2665032890', 1, 'importstore.sanluis@gmail.com', 'Belgrano 47 local 1', '', NULL, '2025-11-12 23:14:31.174793', '', NULL, NULL, 0.00, 1, '', '', '', '', '', '', '', '', '', '', '', 1, 1, 0, '', 1, 1, '', '', '', '', '', '', '', '');
...
-- Volcando datos para la tabla sistema_negocio.crm_cliente: ~6 rows (aproximadamente)
INSERT INTO `crm_cliente` (`id`, `nombre`, `telefono`, `email`, `tipo_cliente`, `instagram_handle`, `fecha_creacion`, `ultima_actualizacion`) VALUES
	...
	(3, 'caca', 'caca', NULL, 'Minorista', NULL, '2025-11-13 23:05:30.894709', '2025-11-13 23:05:30.894709'),
	(4, 'Facundo Bastias', 'Facundo Bastias', NULL, 'Minorista', NULL, '2025-11-14 16:37:09.311891', '2025-11-14 16:37:09.311891'),
	(5, 'Emanuel', '5492665032890', NULL, 'Potencial', NULL, '2025-11-15 00:33:10.512087', '2025-11-15 14:58:05.013602'),
	(6, 'Cliente 1181', '16315551181', NULL, 'Potencial', NULL, '2025-11-15 00:51:02.402397', '2025-11-15 00:51:02.403399');

-- Volcando estructura para tabla sistema_negocio.crm_clientecontexto
CREATE TABLE IF NOT EXISTS `crm_clientecontexto` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `productos_interes` json NOT NULL,
  `categorias_preferidas` json NOT NULL,
  ...
  `tags_comportamiento` json NOT NULL,
  ...
  CONSTRAINT `crm_clientecontexto_cliente_id_e7e1a085_fk_crm_cliente_id` FOREIGN KEY (`cliente_id`) REFERENCES `crm_cliente` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sistema_negocio.crm_clientecontexto: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_negocio.crm_conversacion: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla sistema_negocio.crm_cotizacion
CREATE TABLE IF NOT EXISTS `crm_cotizacion` (
  ...
  PRIMARY KEY (`id`),
  KEY `crm_cotizacion_cliente_id_77934741_fk_crm_cliente_id` (`cliente_id`),
  KEY `crm_cotizacion_conversacion_id_56749d32_fk_crm_conversacion_id` (`conversacion_id`),
  KEY `crm_cotizacion_venta_relacionada_id_690d174b_fk_ventas_venta_id` (`venta_relacionada_id`),
  CONSTRAINT `crm_cotizacion_cliente_id_77934741_fk_crm_cliente_id` FOREIGN KEY (`cliente_id`) REFERENCES `crm_cliente` (`id`),
  CONSTRAINT `crm_cotizacion_conversacion_id_56749d32_fk_crm_conversacion_id` FOREIGN KEY (`conversacion_id`) REFERENCES `crm_conversacion` (`id`),
  CONSTRAINT `crm_cotizacion_venta_relacionada_id_690d174b_fk_ventas_venta_id` FOREIGN KEY (`venta_relacionada_id`) REFERENCES `ventas_venta` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sistema_negocio.crm_cotizacion: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_negocio.crm_mensaje: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_negocio.django_admin_log: ~14 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_negocio.django_content_type: ~24 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_negocio.django_migrations: ~49 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_negocio.django_session: ~37 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_negocio.historial_registrohistorial: ~71 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `inventario_categoria` (
  ...
  CONSTRAINT `inventario_categoria_parent_id_ca5d5e55_fk_inventari` FOREIGN KEY (`parent_id`) REFERENCES `inventario_categoria` (`id`),
  CONSTRAINT `inventario_categoria_chk_1` CHECK ((`garantia_dias` >= 0))
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla sistema_negocio.inventario_categoria: ~5 rows (aproximadamente)
...
INSERT INTO `inventario_detalleiphone` (`id`, `imei`, `salud_bateria`, `fallas_detectadas`, `es_plan_canje`, `costo_usd`, `precio_venta_usd`, `precio_oferta_usd`, `notas`, `foto`, `creado`, `actualizado`, `variante_id`) VALUES
	...
	(7, NULL, 100, '', 1, 200.00, 250.00, NULL, '', '', '2025-11-14 00:07:07.862305', '2025-11-14 00:07:07.862305', 454);

-- Volcando estructura para tabla sistema_negocio.inventario_plancanjeconfig
CREATE TABLE IF NOT EXISTS `inventario_plancanjeconfig` (
  ...
  `descuentos_bateria` json NOT NULL,
  `descuentos_estado` json NOT NULL,
  `descuentos_accesorios` json NOT NULL,
  ...
  `creado` datetime(6) NOT NULL,
  `actualizado` datetime(6) NOT NULL,
  `descuentos_botones` json NOT NULL DEFAULT (_utf8mb4'{}'),
  `descuentos_camara` json NOT NULL DEFAULT (_utf8mb4'{}'),
  `descuentos_marco` json NOT NULL DEFAULT (_utf8mb4'{}'),
  `descuentos_pantalla` json NOT NULL DEFAULT (_utf8mb4'{}'),
  PRIMARY KEY (`id`),
  UNIQUE KEY `inventario_plancanjeconfig_modelo_iphone_capacidad_a6a0ef18_uniq` (`modelo_iphone`,`capacidad`),
  KEY `idx_plan_canje_modelo_cap` (`modelo_iphone`,`capacidad`),
  KEY `idx_plan_canje_activo` (`activo`)
) ENGINE=InnoDB AUTO_INCREMENT=88 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sistema_negocio.inventario_plancanjeconfig: ~86 rows (aproximadamente)
...
-- Volcando estructura para tabla sistema_negocio.inventario_plancanjetransaccion
CREATE TABLE IF NOT EXISTS `inventario_plancanjetransaccion` (
  ...
  `iphone_recibido_bateria` int unsigned NOT NULL,
  `iphone_recibido_estado` varchar(20) NOT NULL,
  `iphone_recibido_accesorios` json NOT NULL,
  ...
  `detalle_iphone_recibido_id` bigint DEFAULT NULL,
  `iphone_entregado_id` bigint DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `inventario_plancanje_detalle_iphone_recib_c6e63b68_fk_inventari` (`detalle_iphone_recibido_id`),
  KEY `inventario_plancanje_iphone_entregado_id_ae5bd27f_fk_inventari` (`iphone_entregado_id`),
  KEY `inventario_plancanje_vendedor_id_d1fcc04e_fk_auth_user` (`vendedor_id`),
  KEY `inventario_plancanje_venta_asociada_id_69fed8c1_fk_ventas_ve` (`venta_asociada_id`),
  KEY `idx_canje_fecha` (`fecha`),
  KEY `idx_canje_cliente` (`cliente_id`),
  CONSTRAINT `inventario_plancanje_cliente_id_417bc6c0_fk_crm_clien` FOREIGN KEY (`cliente_id`) REFERENCES `crm_cliente` (`id`),
  CONSTRAINT `inventario_plancanje_detalle_iphone_recib_c6e63b68_fk_inventari` FOREIGN KEY (`detalle_iphone_recibido_id`) REFERENCES `inventario_detalleiphone` (`id`),
  CONSTRAINT `inventario_plancanje_iphone_entregado_id_ae5bd27f_fk_inventari` FOREIGN KEY (`iphone_entregado_id`) REFERENCES `inventario_productovariante` (`id`),
  CONSTRAINT `inventario_plancanje_vendedor_id_d1fcc04e_fk_auth_user` FOREIGN KEY (`vendedor_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `inventario_plancanje_venta_asociada_id_69fed8c1_fk_ventas_ve` FOREIGN KEY (`venta_asociada_id`) REFERENCES `ventas_venta` (`id`),
  CONSTRAINT `inventario_plancanjetransaccion_chk_1` CHECK ((`iphone_recibido_bateria` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sistema_negocio.inventario_plancanjetransaccion: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_negocio.inventario_precio: ~273 rows (aproximadamente)
INSERT INTO `inventario_precio` (`id`, `tipo_precio`, `costo`, `precio_venta_normal`, `precio_venta_minimo`, `precio_venta_descuento`, `variante_id`, `moneda`, `activo`, `actualizado`, `creado`, `precio`, `tipo`) VALUES
	...
	(380, 'MINORISTA', 1.00, 1.00, 1.00, NULL, 387, 'ARS', 1, '2025-11-14 17:58:11.464771', '2025-11-13 14:13:05.000000', 1560000.00, 'MINORISTA'),
	...
	(448, 'MAYORISTA', 0.00, 1212.00, 1212.00, NULL, 387, 'ARS', 1, '2025-11-14 18:48:54.521774', '2025-11-14 15:48:54.000000', 1212.00, 'MAYORISTA');
...
-- Volcando datos para la tabla sistema_negocio.inventario_producto: ~233 rows (aproximadamente)
INSERT INTO `inventario_producto` (`id`, `nombre`, `descripcion`, `actualizado`, `categoria_id`, `proveedor_id`, `estado`, `seo_descripcion`, `seo_titulo`, `activo`, `codigo_barras`, `imagen_codigo_barras`, `creado`) VALUES
	...
	(330, 'Adaptador 20W Tipo C Oogan', '', '2025-11-13 20:23:36.082355', 1, NULL, 'ACTIVO', NULL, NULL, 1, '', NULL, '2025-11-13 17:13:05.538404'),
	...
	(395, 'iPhone 11', '', '2025-11-14 00:07:07.824470', 2, NULL, 'ACTIVO', NULL, NULL, 1, NULL, NULL, '2025-11-14 00:07:07.823241');

-- Volcando estructura para tabla sistema_negocio.inventario_productoimagen
CREATE TABLE IF NOT EXISTS `inventario_productoimagen` (
  ...
  PRIMARY KEY (`id`),
  KEY `inventario_productoi_producto_id_dc6f4534_fk_inventari` (`producto_id`),
  CONSTRAINT `inventario_productoi_producto_id_dc6f4534_fk_inventari` FOREIGN KEY (`producto_id`) REFERENCES `inventario_producto` (`id`),
  CONSTRAINT `inventario_productoimagen_chk_1` CHECK ((`orden` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sistema_negocio.inventario_productoimagen: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_negocio.inventario_productovariante: ~268 rows (aproximadamente)
INSERT INTO `inventario_productovariante` (`id`, `nombre_variante`, `stock`, `producto_id`, `codigo_barras`, `peso`, `sku`, `activo`, `actualizado`, `atributo_1`, `atributo_2`, `creado`, `stock_actual`, `stock_minimo`, `qr_code`) VALUES
	...
	(199, '', 0, 174, NULL, 0.00, 'ADAPTADOR-5W-USB-IPHONE-CARGADORCABLE', 1, '2025-11-14 17:49:39.874861', '', '', '2025-11-13 17:13:03.095307', 2, 0, NULL),
	...
	(219, '', 0, 191, NULL, 0.00, 'ADAPTADOR-APPLE-20W-TIPO-C-ORIGINAL-APPLE', 1, '2025-11-14 17:54:17.418081', '', '', '2025-11-13 17:13:03.399118', 2, 0, NULL),
	...
	(387, '', 0, 330, NULL, 0.00, 'ADAPTADOR-20W-TIPO-C-OOGAN', 1, '2025-11-15 00:35:46.612715', '', '', '2025-11-13 17:13:05.542481', 2, 0, NULL),
	...
	(396, '', 1, 339, NULL, 0.00, 'TV-STICK-WATCH', 1, '2025-11-13 20:23:39.483898', '', '', '2025-11-13 17:13:05.669760', 1, 0, NULL),
	...
	(438, '', 9, 379, NULL, 0.00, 'ADAPTADOR-CARGADO-AUTO-A-TIPO-C', 1, '2025-11-13 20:23:36.163019', '', '', '2025-11-13 17:13:06.248604', 9, 0, NULL),
	...
	(454, 'iPhone 11 64GB Morado', 1, 395, NULL, 0.00, 'IPHONE-11-64GB-MORADO', 1, '2025-11-14 00:07:07.831165', '64GB', 'Morado', '2025-11-14 00:07:07.831165', 1, 0, NULL);
...
-- Volcando datos para la tabla sistema_negocio.locales_local: ~0 rows (aproximadamente)
...
INSERT INTO `ventas_carritoremoto` (`id`, `items`, `actualizado`, `usuario_id`) VALUES
	(1, '[]', '2025-11-15 00:57:54.939924', 2);
...
-- Volcando datos para la tabla sistema_negocio.ventas_detalleventa: ~88 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_negocio.ventas_solicitudimpresion: ~12 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_negocio.ventas_venta: ~58 rows (aproximadamente)
INSERT INTO `ventas_venta` (`id`, `fecha`, `metodo_pago`, `nota`, `cliente_documento`, `cliente_nombre`, `comprobante_pdf`, `vendedor_id`, `actualizado`, `cliente_id`, `descuento_total_ars`, `impuestos_ars`, `status`, `subtotal_ars`, `total_ars`, `es_pago_mixto`, `metodo_pago_2`, `monto_pago_1`, `monto_pago_2`, `descuento_metodo_pago_ars`) VALUES
	...
	('POS-1AF59883', '2025-11-13 23:46:13.169168', 'EFECTIVO_ARS', '', '', '', 'comprobantes/comprobante_POS-1AF59883.pdf', 2, '2025-11-13 23:46:13.398718', NULL, 0.00, 0.00, 'COMPLETADO', 2122500.00, 2122500.00, 0, NULL, NULL, NULL, 0.00),
	...
	('POS-31A9A44D', '2025-11-13 18:23:20.234003', 'EFECTIVO_ARS', '', '', '', 'comprobantes/comprobante_POS-31A9A44D.pdf', 2, '2025-11-13 18:23:20.512273', NULL, 80909.55, 0.00, 'COMPLETADO', 122375.00, 41465.45, 1, 'TARJETA', 1222.00, 40426.75, 183.30),
	...
	('POS-3EEECD18', '2025-11-14 16:37:09.313901', 'EFECTIVO_ARS', 'Retirado por el Local a Consignacion ', '', 'Facundo Bastias', 'comprobantes/comprobante_POS-3EEECD18.pdf', 2, '2025-11-14 16:37:09.736437', 4, 0.00, 0.00, 'PENDIENTE_PAGO', 201860.00, 201860.00, 0, NULL, NULL, NULL, 0.00),
	...
	('POS-56C4E11D', '2025-11-13 23:13:09.150122', 'EFECTIVO_ARS', '', '', '', 'comprobantes/comprobante_POS-56C4E11D.pdf', 2, '2025-11-13 23:13:09.409816', NULL, 0.00, 0.00, 'COMPLETADO', 2122501.00, 2122501.00, 0, NULL, NULL, NULL, 0.00),
	...
	('POS-611E669B', '2025-11-13 23:12:47.308361', 'EFECTIVO_ARS', '', '', '', 'comprobantes/comprobante_POS-611E669B.pdf', 2, '2025-11-13 23:12:47.590545', NULL, 0.00, 0.00, 'COMPLETADO', 1.00, 1.00, 0, NULL, NULL, NULL, 0.00),
	...
	('POS-6B0D8096', '2025-11-15 00:57:54.260839', 'EFECTIVO_ARS', '', '', '', 'comprobantes/comprobante_POS-6B0D8096.pdf', 2, '2025-11-15 00:57:54.544811', NULL, 0.00, 444150.00, 'COMPLETADO', 2115000.00, 2559150.00, 0, NULL, NULL, NULL, 0.00),
	('POS-6B100E8F', '2025-11-13 18:27:06.712040', 'EFECTIVO_ARS', '', '2665032890', 'Sosa Raul emanuel', 'comprobantes/comprobante_POS-6B100E8F.pdf', 2, '2025-11-13 18:27:06.991148', 1, 0.00, 0.00, 'COMPLETADO', 1799181.74, 1799181.74, 0, NULL, NULL, NULL, 0.00),
	('POS-762454C2', '2025-11-13 19:44:22.118175', 'EFECTIVO_ARS', '', '', '', 'comprobantes/comprobante_POS-762454C2.pdf', 2, '2025-11-13 19:44:22.399872', NULL, 0.00, 0.00, 'COMPLETADO', 4990.00, 4990.00, 0, NULL, NULL, NULL, 0.00),
	...
	('POS-90E0619E', '2025-11-13 23:05:30.912430', 'EFECTIVO_ARS', '', '', 'caca', 'comprobantes/comprobante_POS-90E0619E.pdf', 2, '2025-11-13 23:05:31.214598', 3, 0.00, 0.00, 'COMPLETADO', 8.00, 8.00, 0, NULL, NULL, NULL, 0.00),
	...
	('POS-98BB15AC', '2025-11-13 19:52:34.409944', 'EFECTIVO_ARS', '', '2665032890', 'Sosa Raul emanuel', 'comprobantes/comprobante_POS-98BB15AC.pdf', 2, '2025-11-13 19:52:34.835277', 1, 41559.03, 49455.25, 'CANCELADO', 277060.23, 284956.45, 0, NULL, NULL, NULL, 41559.03),
	...
	('POS-B00486BF', '2025-11-13 18:39:43.757209', 'EFECTIVO_ARS', '', '', '', 'comprobantes/comprobante_POS-B00486BF.pdf', 2, '2025-11-13 18:39:44.022967', NULL, 0.00, 0.00, 'COMPLETADO', 17916.59, 17916.59, 0, NULL, NULL, NULL, 0.00),
	...
	('POS-CA846B38', '2025-11-13 18:50:39.142976', 'EFECTIVO_ARS', '', '2665032890', 'Sosa Raul emanuel', 'comprobantes/comprobante_POS-CA846B38.pdf', 2, '2025-11-13 18:50:39.396166', 1, 318375.00, 0.00, 'COMPLETADO', 2122500.00, 1804125.00, 0, NULL, NULL, NULL, 318375.00),
	...
	('POS-D485FC80', '2025-11-13 22:51:38.730466', 'EFECTIVO_ARS', '', '', '', 'comprobantes/comprobante_POS-D485FC80.pdf', 2, '2025-11-13 22:51:39.023980', NULL, 0.00, 0.00, 'COMPLETADO', 2122500.00, 2122500.00, 0, NULL, NULL, NULL, 0.00),
